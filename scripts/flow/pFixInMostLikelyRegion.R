...
pltResults <- function(dat, nr)
{
	...
	pltDat = filter(ClassAccResults2, biasmodel %in% c('Clarke-Tatler2014', 're-fit', 'N', 'tN'))
...
ggsave(paste('figs/llh_Training_RegAcc.pdf', sep=''), width=12, height=6)
...
ggsave(paste('figs/llh_Testing_RegAcc.pdf', sep=''), width=12, height=3)
