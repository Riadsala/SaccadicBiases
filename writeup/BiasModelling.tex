...
\begin{figure}
\centering
\subfigure{\includegraphics[width=3.6cm]{../scripts/leftVright/graphs/leftrightbias.pdf}}
\subfigure{\includegraphics[width=3.6cm]{../scripts/leftVright/graphs/updownbias.pdf}}
