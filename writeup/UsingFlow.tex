...
\begin{figure*}[htb]
\centering
\subfigure{\includegraphics[width=3.6cm]{../scripts/coarse2fine/figs/xFixComparison}}
\subfigure{\includegraphics[width=3.6cm]{../scripts/coarse2fine/figs/yFixComparison}}
\subfigure{\includegraphics[width=3.6cm]{../scripts/coarse2fine/figs/ampSaccComparison}}
\subfigure{\includegraphics[width=3.6cm]{../scripts/coarse2fine/figs/saccAmpOverTimeFlow}}
